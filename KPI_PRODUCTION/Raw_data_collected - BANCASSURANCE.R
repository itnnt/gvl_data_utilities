...
# MAIN PROCESS ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
if(interactive()) {
  import_agentlist_from_msaccess("20171130", accessdb = "d:/Data/DA_201711/KPI_BANCA.accdb", dbfile =
                                   "KPI_PRODUCTION/main_database_BANCASSURANCE.db")
  import_kpiproduction_msaccess(c('KPITotal', 'Manpower_Active Ratio'),
                                accessdb = "d:/Data/DA_201711/KPI_BANCA.accdb",
                                dbfile = "KPI_PRODUCTION/main_database_BANCASSURANCE.db")
  import_kpiproduction_msaccess(c('Product'), accessdb = "d:/Data/DA_201711/KPI_PRODUCTION.accdb", dbfile =
                                  "KPI_PRODUCTION/main_database_BANCASSURANCE.db")
}
